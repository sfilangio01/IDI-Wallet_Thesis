...
// Note: Duplicate DIDs and DIDs extracted from identity names have been consolidated/cleaned.
const ALL_DIDS = [
    // Existing DIDs
...
/**
 * Runs the full DID resolution test suite against all provided DIDs.
 */
async function runDidTestSuite() {
    ...
    // Retrieve elements inside the function to ensure they are defined
    ...
    // Calculate latency for failed resolutions
    ...
    // Get the top 5 slowest successful resolutions
...
export function setupDidResolverEventListeners() {
    ...
    if (!resolveButton || !didInput || !resultContainer || !testButton) {
